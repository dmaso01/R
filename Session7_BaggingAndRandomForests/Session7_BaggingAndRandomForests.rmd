...
#LEGEND
legend("topright", legend = C("single tree", "majority vote", "taking average", "majority vote improved", "taking average improved"), col=c("red", "black", "blue", "orange", "green"), lty=c(2, 1, 1, 1, 1))
```